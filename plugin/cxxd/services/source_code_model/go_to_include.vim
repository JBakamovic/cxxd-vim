...
" """"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
function! cxxd#services#source_code_model#go_to_include#run(filename, line, show_definition_in_preview_window)
    if g:cxxd_src_code_model['started'] && g:cxxd_src_code_model['services']['go_to_include']['enabled']
        ...
        if cxxd#utils#is_more_modifications_done(winnr())
            "echomsg 'Serializing buffer contents from GO-TO-INCLUDE.'
