...
" """"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
function! cxxd#server#start_all_services()
    " In the new architecture, we might just send requests to start?
    " Or relying on auto-start? 
    " The original code called python functions that put messages on the queue.
    " We need to emulate that.
    " 0xF0 = START_ALL_SERVICES
