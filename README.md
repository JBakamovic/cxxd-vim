...
There's a fix for second issue in `performance_fix_for_semantic_syntax_hl` branch. To try it out just do the following in your `cxxd-vim` root directory: `git fetch && git checkout performance_fix_for_semantic_syntax_hl`
